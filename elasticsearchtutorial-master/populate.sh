...
curl -XDELETE "http://localhost:9200/get-group" > /dev/null
curl -XDELETE "http://localhost:9200/get-event" > /dev/null

# Create the next index using mapping.json
echo "Creating 'get-together' index..."
curl -XPUT "http://localhost:9200/get-group" -H 'Content-Type: application/json' -d"@mapping_group.json"
curl -XPUT "http://localhost:9200/get-event" -H 'Content-Type: application/json' -d"@mapping_event.json"

# Wait for index to become yellow
curl "http://localhost:9200/get-group/_health?wait_for_status=yellow&timeout=10s" > /dev/null
curl "http://localhost:9200/get-event/_health?wait_for_status=yellow&timeout=10s" > /dev/null
echo
...
curl -XPUT "http://localhost:9200/get-group/default/1" -H 'Content-Type: application/json' -d'{
  "name": "Denver Clojure",
...
echo
curl -XPUT "http://localhost:9200/get-group/default/2" -H 'Content-Type: application/json' -d'{
...
echo
curl -XPUT "http://localhost:9200/get-group/default/3" -H 'Content-Type: application/json' -d'{
...
echo
curl -XPUT "http://localhost:9200/get-group/default/4" -H 'Content-Type: application/json' -d'{
...
echo
curl -XPUT "http://localhost:9200/get-group/default/5" -H 'Content-Type: application/json' -d'{
...
curl -XPUT "http://localhost:9200/get-event/default/100?parent=1" -H 'Content-Type: application/json' -d'{
  "host": ["Lee", "Troy"],
...
echo
curl -XPUT "http://localhost:9200/get-event/default/101?parent=1" -H 'Content-Type: application/json' -d'{
  "host": "Sean",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/102?parent=1" -H 'Content-Type: application/json' -d'{
  "host": "Daniel",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/103?parent=2" -H 'Content-Type: application/json' -d'{
  "host": "Lee",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/104?parent=2" -H 'Content-Type: application/json' -d'{
  "host": "Lee",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/105?parent=2" -H 'Content-Type: application/json' -d'{
  "host": "Lee",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/106?parent=3" -H 'Content-Type: application/json' -d'{
  "host": "Mik",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/107?parent=3" -H 'Content-Type: application/json' -d'{
  "host": "Mik",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/108?parent=3" -H 'Content-Type: application/json' -d'{
  "host": "Elyse",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/109?parent=4" -H 'Content-Type: application/json' -d'{
  "host": "Andy",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/110?parent=4" -H 'Content-Type: application/json' -d'{
  "host": "Andy",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/111?parent=4" -H 'Content-Type: application/json' -d'{
  "host": "Andy",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/112?parent=5" -H 'Content-Type: application/json' -d'{
  "host": "Dave Nolan",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/113?parent=5" -H 'Content-Type: application/json' -d'{
  "host": "Dave",
...
echo
curl -XPUT "http://localhost:9200/get-event/default/114?parent=5" -H 'Content-Type: application/json' -d'{
  "host": "Yann",
...
curl -XPOST "http://localhost:9200/get-group/_refresh"
curl -XPOST "http://localhost:9200/get-event/_refresh"
